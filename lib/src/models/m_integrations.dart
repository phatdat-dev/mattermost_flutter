...
class MIntegrations {
  ...
  MIntegrations({required this.incomingWebhooks, required this.outgoingWebhooks, required this.commands, required this.oauthApps});
  ...
  Map<String, dynamic> toJson() {
    return {'incoming_webhooks': incomingWebhooks, 'outgoing_webhooks': outgoingWebhooks, 'commands': commands, 'oauth_apps': oauthApps};
  }
}
