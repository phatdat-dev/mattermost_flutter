...
class SharedChannel {
  ...
  factory SharedChannel.fromJson(Map<String, dynamic> json) {
...
class RemoteCluster {
  ...
  factory RemoteCluster.fromJson(Map<String, dynamic> json) {
...
class RemoteClusterInvite {
  ...
  factory RemoteClusterInvite.fromJson(Map<String, dynamic> json) {
...
class CreateRemoteClusterInviteRequest {
  final String name;
  final String siteUrl;
  final int? expiresIn;

  CreateRemoteClusterInviteRequest({
    required this.name,
    required this.siteUrl,
    this.expiresIn,
  });
