...
class MSamlApi {
  ...
  Future<void> uploadIdpCertificate(File certificate) async {
    try {
      ...
      await _dio.post('/api/v4/saml/certificate/idp', data: formData);
    } catch (e) {
      rethrow;
    }
  }
  ...
  Future<void> uploadPublicCertificate(File certificate) async {
    try {
      ...
      await _dio.post('/api/v4/saml/certificate/public', data: formData);
    } catch (e) {
      rethrow;
    }
  }
  ...
  Future<void> uploadPrivateKey(File key) async {
    try {
      ...
      await _dio.post('/api/v4/saml/certificate/private', data: formData);
    } catch (e) {
      rethrow;
    }
  }
  ...
  Future<MSamlCertificateStatus> getCertificateStatus() async {
    try {
      final response = await _dio.get('/api/v4/saml/certificate/status');
      return MSamlCertificateStatus.fromJson(response.data);
    } catch (e) {
      rethrow;
    }
  }
