...
import 'package:mattermost_flutter/src/models/m_data_retention.dart';
...
class MDataRetentionApi {
  ...
  Future<List<MTeamDataRetentionPolicy>> getTeamPolicies({int page = 0, int perPage = 60}) async {
    try {
  ...
  Future<List<MChannelDataRetentionPolicy>> getChannelPolicies({int page = 0, int perPage = 60}) async {
    try {
      final response = await _dio.get(
  ...
  Future<MTeamDataRetentionPolicy> createTeamPolicy(MCreateTeamPolicyRequest request) async {
    try {
      final response = await _dio.post('/api/v4/data_retention/policies_teams', data: request.toJson());
  ...
  Future<MChannelDataRetentionPolicy> createChannelPolicy(MCreateChannelPolicyRequest request) async {
    try {
      final response = await _dio.post('/api/v4/data_retention/policies_channels', data: request.toJson());
  ...
  Future<MTeamDataRetentionPolicy> getTeamPolicy(String policyId) async {
    try {
      final response = await _dio.get('/api/v4/data_retention/policies_teams/$policyId');
      return MTeamDataRetentionPolicy.fromJson(response.data);
    } catch (e) {
      rethrow;
    }
  ...
  Future<MChannelDataRetentionPolicy> getChannelPolicy(String policyId) async {
    try {
      final response = await _dio.get('/api/v4/data_retention/policies_channels/$policyId');
      return MChannelDataRetentionPolicy.fromJson(response.data);
    } catch (e) {
      rethrow;
    }
  ...
  Future<MTeamDataRetentionPolicy> updateTeamPolicy(String policyId, MUpdateTeamPolicyRequest request) async {
    try {
      final response = await _dio.patch('/api/v4/data_retention/policies_teams/$policyId', data: request.toJson());
      return MTeamDataRetentionPolicy.fromJson(response.data);
    } catch (e) {
      rethrow;
    }
  ...
  Future<MChannelDataRetentionPolicy> updateChannelPolicy(String policyId, MUpdateChannelPolicyRequest request) async {
    try {
      final response = await _dio.patch('/api/v4/data_retention/policies_channels/$policyId', data: request.toJson());
      return MChannelDataRetentionPolicy.fromJson(response.data);
    } catch (e) {
      rethrow;
    }
  ...
  Future<List<String>> getTeamsForPolicy(String policyId, {int page = 0, int perPage = 60}) async {
    try {
      final response = await _dio.get(
  ...
  Future<List<String>> getChannelsForPolicy(String policyId, {int page = 0, int perPage = 60}) async {
    try {
      final response = await _dio.get(
  ...
  Future<void> addTeamsToPolicy(String policyId, List<String> teamIds) async {
    try {
      await _dio.post('/api/v4/data_retention/policies_teams/$policyId/teams', data: teamIds);
    } catch (e) {
      rethrow;
    }
  }
  ...
  Future<void> addChannelsToPolicy(String policyId, List<String> channelIds) async {
    try {
      await _dio.post('/api/v4/data_retention/policies_channels/$policyId/channels', data: channelIds);
    } catch (e) {
      rethrow;
    }
  }
  ...
  Future<void> removeTeamFromPolicy(String policyId, String teamId) async {
    try {
      await _dio.delete('/api/v4/data_retention/policies_teams/$policyId/teams/$teamId');
    } catch (e) {
      rethrow;
    }
  }
  ...
  Future<void> removeChannelFromPolicy(String policyId, String channelId) async {
    try {
      await _dio.delete('/api/v4/data_retention/policies_channels/$policyId/channels/$channelId');
    } catch (e) {
      rethrow;
    }
  }
